...
$sth = mysql_query("SELECT MAX(goruntulenme_sayisi) FROM `ozel_video_depo` GROUP BY video_id ORDER BY MAX(goruntulenme_sayisi) DESC LIMIT 0,$cekilecek_miktar");
$flag = true;
$table = array();
$table['cols'] = array(
...
$sth_t = mysql_query("SELECT video_id,adi,MAX(goruntulenme_sayisi),like_sayisi,dislike_sayisi,toplam_yorum_sayisi,yukleme_tarihi FROM `ozel_video_depo` GROUP BY video_id ORDER BY MAX(goruntulenme_sayisi) DESC LIMIT 0,$cekilecek_miktar");
$flag_t = true;
$table_t = array();
$table_t['cols'] = array(
...
$sth1 = mysql_query("SELECT MAX(like_sayisi),dislike_sayisi FROM `ozel_video_depo` GROUP BY video_id ORDER BY MAX(like_sayisi) DESC LIMIT 0,$cekilecek_miktar");
$flag1 = true;
$table1 = array();
$table1['cols'] = array(
    array('label' => 'id', 'type' => 'string'),
...
$sth1_t = mysql_query("SELECT video_id,adi,goruntulenme_sayisi,MAX(like_sayisi),dislike_sayisi,toplam_yorum_sayisi,yukleme_tarihi FROM `ozel_video_depo` GROUP BY video_id ORDER BY MAX(like_sayisi) DESC LIMIT 0,$cekilecek_miktar");
$flag1_t = true;
$table1_t = array();
$table1_t['cols'] = array(
    array('label' => 'video_id', 'type' => 'string'),
...
$sth2 = mysql_query("SELECT like_sayisi,MAX(dislike_sayisi) FROM `ozel_video_depo` GROUP BY video_id ORDER BY MAX(dislike_sayisi) DESC LIMIT 0,$cekilecek_miktar");
$flag2 = true;
$table2 = array();
$table2['cols'] = array(
    array('label' => 'id', 'type' => 'string'),
...
$sth2_t = mysql_query("SELECT video_id,adi,goruntulenme_sayisi,like_sayisi,MAX(dislike_sayisi),toplam_yorum_sayisi,yukleme_tarihi FROM `ozel_video_depo` GROUP BY video_id ORDER BY MAX(dislike_sayisi) DESC LIMIT 0,$cekilecek_miktar");
$flag2_t = true;
$table2_t = array();
$table2_t['cols'] = array(
    array('label' => 'video_id', 'type' => 'string'),
...
$sth3 = mysql_query("SELECT MAX(toplam_yorum_sayisi) FROM `ozel_video_depo` GROUP BY video_id ORDER BY MAX(toplam_yorum_sayisi) DESC LIMIT 0,$cekilecek_miktar");
$flag3 = true;
$table3 = array();
$table3['cols'] = array(
    array('label' => 'id', 'type' => 'string'),
...
$sth3_t = mysql_query("SELECT video_id,adi,goruntulenme_sayisi,like_sayisi,dislike_sayisi,MAX(toplam_yorum_sayisi),yukleme_tarihi FROM `ozel_video_depo` GROUP BY video_id ORDER BY MAX(toplam_yorum_sayisi) DESC LIMIT 0,$cekilecek_miktar");
$flag3_t = true;
$table3_t = array();
$table3_t['cols'] = array(
    array('label' => 'video_id', 'type' => 'string'),
    ...
    <div id="orta">
        ...
        <div id="orta_navigasyon">
            <ul id="menu">
                ...
                <li><a href="videolar.php" style="color: black;">Video Analizleri</a></li>
        ...
        <div id="icerikler">
            ...
            <div id="liste_sayisi" style='height: 37px;'>
                <ul id="menu2" style="height: 37px; font-size: 14px; padding-left: 10px;">
                    <li style=""><a>Video Analizleri</a></li>
                </ul>
            </div>
            ...
            <div id="liste_sayisi">
                <ul id="menu2">
                    ...
                    <li><a href="videolar.php?cek=10" <?php if ($cekilecek_miktar == 10) echo 'class="tikla"'; ?> >10</a></li>
                    <li><a href="videolar.php?cek=20" <?php if ($cekilecek_miktar == 20) echo 'class="tikla"'; ?> >20</a></li>
                    <li><a href="videolar.php?cek=30" <?php if ($cekilecek_miktar == 30) echo 'class="tikla"'; ?> >30</a></li>
                    <li><a href="videolar.php?cek=40" <?php if ($cekilecek_miktar == 40) echo 'class="tikla"'; ?> >40</a></li>
                </ul>
            </div>
